...
export const metadata = {
    title: 'Jesús | Personbal Portfolio',
    description:
        'Jesús Viafara is a full-stack web developer with 2 years of experience.',
};
    ...
    return (
        <html lang='en'>
            <body
                ...
                <div
                    className='bg-[#fbe2e3] absolute top-[-6rem] -z-[10] right-[11rem] h-[31.25rem] w-[31.25rem] rounded-full
